...
public class pi6 {
    ...
    private static final int[] PI_input_pin = {20};
    ...
    public static void pi6_println(String s){
        System.out.println("UPDATED - version 6!!! Jiaqi is testing GPIO...");
    ...
    public static void set_high_pi6(int pinNo){
        System.out.println("on");
        output_pins[pinNo].high();
    }

    public static void set_low_pi6(int pinNo){
        System.out.println("off");
        output_pins[pinNo].low();
    }

    public static int get_pin_info(int pinNo){
        PinState state;
